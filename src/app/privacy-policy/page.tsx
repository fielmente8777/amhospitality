...
import { policiesPageData } from "./privacyData";

const privacyPolicyItem =
  policiesPageData.find((p) => p.slug === "privacy-policy") ||
  policiesPageData[0];

export const metadata: Metadata = {
  title: privacyPolicyItem.metaData.title,
  description: privacyPolicyItem.metaData.description,
};
      ...
      <Section defaultPadding={false} sectionClassName="py-10 md:py-14">
        <Container>
          <div
            ...
            dangerouslySetInnerHTML={{ __html: privacyPolicyItem.content }}
          />
        </Container>
      </Section>
    </main>
