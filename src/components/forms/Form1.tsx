...
const Form1 = ({ gridView }: Props) => {
  ...
  return (
    <form
      ...
      className={`${gridView ? "flex flex-col gap-2" : "grid md:grid-cols-5 items-center gap-3.5 "} font-body px-4 py-2 bg-white/95 rounded-4xl overflow-hidden max-md:divide-y divide-p1`}
    >
